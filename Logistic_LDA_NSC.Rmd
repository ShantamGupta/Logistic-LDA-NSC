---
title: "Prediction of Coronary Heart Disease(CHD) using South African Heart Disease Data"
...
x <-read.csv("https://statweb.stanford.edu/~tibs/ElemStatLearn/datasets/SAheart.data",header = T)
